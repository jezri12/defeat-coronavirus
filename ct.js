...
ct.inputs.addAction('XMove', [{"code":"keyboard.ArrowRight"},{"code":"keyboard.KeyD"},{"code":"keyboard.ArrowLeft","multiplier":-1},{"code":"keyboard.KeyA","multiplier":-1}]);
ct.inputs.addAction('YMove', [{"code":"keyboard.ArrowUp","multiplier":-1},{"code":"keyboard.KeyW","multiplier":-1},{"code":"keyboard.ArrowDown"},{"code":"keyboard.KeyS"}]);
ct.inputs.addAction('YW', [{"code":"keyboard.Space"}]);
...
ct.rooms.templates['Main-Game-Room'] = {
    name: 'Main-Game-Room',
    width: 800,
    height: 600,
    objects: [],
    bgs: [{"depth":-3,"texture":"Blue","extends":{}}],
    ...
    if(this.enemyT > 0){
        ...
        this.enemyT = 60
        ct.types.copy("Enemy",ct.random.range(0,800-64),ct.random.range(0,600-64))
    }

}else{

    ct.rooms.switch("Game-Over-Room")
    ...
    onCreate() {
        this.selPlayer = ct.types.copy("Player",448,256)
...
this.scoreLabel = new PIXI.Text('Score: ' + this.score, ct.styles.get('Score S'));
this.scoreLabel.x = this.scoreLabel.y = 20;
this.addChild(this.scoreLabel);
    }
}
ct.rooms.templates['Game-Over-Room'] = {
    name: 'Game-Over-Room',
    width: 800,
    height: 600,
    objects: [],
    bgs: [{"depth":-2,"texture":"Blue","extends":{}}],
    tiles: [{"depth":10,"tiles":[{"texture":"Player_Id","frame":0,"x":384,"y":256,"width":64,"height":64}]}],
    onStep() {
        if(ct.actions.YW.value){
    ct.rooms.switch("Main-Game-Room")
}
    },
    onDraw() {
...
(function (ct) {
    ...
    ct.res = {
        ...
        soundsError: 0,
        sounds: {},
        registry: [{"Angry":{"frames":1,"shape":{"type":"rect","top":0,"bottom":64,"left":0,"right":64},"anchor":{"x":0,"y":0}},"Happy":{"frames":1,"shape":{"type":"rect","top":0,"bottom":64,"left":0,"right":64},"anchor":{"x":0,"y":0}},"Blue":{"atlas":"./img/t0.png","frames":0,"shape":{"type":"rect","top":0,"bottom":64,"left":0,"right":64},"anchor":{"x":0,"y":0}},"Player_Idle":{"frames":1,"shape":{"type":"rect","top":0,"bottom":64,"left":0,"right":64},"anchor":{"x":0,"y":0}},"coronavirus":{"frames":1,"shape":{"type":"rect","top":0,"bottom":64,"left":0,"right":64},"anchor":{"x":0,"y":0}},"Player_Id":{"frames":1,"shape":{"type":"rect","top":32,"bottom":32,"left":32,"right":32},"anchor":{"x":0.5,"y":0.5}},"hand_wash":{"frames":1,"shape":{"type":"circle","r":32},"anchor":{"x":0.5,"y":0.5}}}][0],
...
if ([false][0] && this instanceof ct.types.Copy) {
    ...
    ct.types.templates["Player"] = {
    depth:0,
    texture: "Player_Id",
    onStep: function () {
this.x += ct.delta * ct.actions.XMove.value * 10
this.y += ct.delta * ct.actions.YMove.value * 10

if(this.first){
    if(ct.actions.YW.value){
        ct.types.copy("hand yeet",this.x,this.y)
        this.first = false
    }
}
if(!ct.actions.YW.value){
...
this.first = true
    ...
    extends: {}};
ct.types.list['Player'] = [];
ct.types.templates["Enemy"] = {
    depth:0,
    texture: "coronavirus",
    onStep: function () {
this.player = ct.room.selPlayer
...
this.x += ct.delta * this.xm *5
this.y += ct.delta * this.ym *5

this.move();

if(ct.place.meet(this,"hand yeet")){
    this.kill = true
    ct.room.score += ct.random.dice(100,200,500,100)
}
    },
    onDraw: function () {
    ...
    onDestroy: function () {
ct.sound.spawn("Beep",{loop:false})
    },
    onCreate: function () {
    ...
    extends: {}};
ct.types.list['Enemy'] = [];
ct.types.templates["Type_e19fd434d964"] = {
    depth:0,
    onStep: function () {
this.move();
    },
    ...
    extends: {}};
ct.types.list['Type_e19fd434d964'] = [];
ct.types.templates["hand yeet"] = {
    depth:0,
    texture: "hand_wash",
    onStep: function () {
if(this.disTimer > 0){
...
ct.sound.init('Beep', {
    wav: './snd/56d075db-5fc5-4203-9540-90ab134dd3d8.wav',
    mp3: false,
    ogg: false
}, {
    poolSize: 5,
